...
class PublicAction extends Action {
	...
	public function note(){
		$note=M("Notes");
		$result=$note->where("user_id=".$_SESSION[C('USER_AUTH_KEY')])->select();
    ...
    public function updatePwd()
    {
        ...
        }else if(I("confirmpassword")!=I("newpassword")){
        	$this->error('两次密码不一致！');
        }else {
