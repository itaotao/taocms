...
<div id="navtab1" style="width: 800px;height:500px;overflow:hidden; border:1px solid #A3C0E8; ">
<div tabid="home" title="站点设置" style="height:100%" >
<iframe frameborder="0" name="showmessage" src="<?php echo U('site');?>"></iframe>
</div>
<div tabid="core" title="核心设置" style="height:100%" >
<iframe frameborder="0" name="core" src="<?php echo U('core');?>"></iframe>
</div>
<div  title="附件设置"  >
