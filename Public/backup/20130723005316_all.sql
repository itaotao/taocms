-- MySQL database dump
...
INSERT INTO `tao_group` VALUES('2','System','系统设置','1','0');
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='菜单表';
...
INSERT INTO `tao_menu` VALUES('8','分组管理','/taotao/admin.php/Group','3','false');
...
INSERT INTO `tao_notes` VALUES('1','90','208','blue','1','null');
...
INSERT INTO `tao_user` VALUES('1','admin','管理员','21232f297a57a5a743894a0e4a801fc3','','1374511984','127.0.0.1','982','8888','liu21st@gmail.com','备注信息','1222907803','1239977420','1','0','');
