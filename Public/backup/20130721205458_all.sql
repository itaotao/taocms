...
DROP TABLE IF EXISTS `tao_group`;

CREATE TABLE `tao_group` (
...
INSERT INTO `tao_group` VALUES('2','App','应用中心','1222841259','0','1','0','0');
...
INSERT INTO `tao_member` VALUES('1','taoatao','12312323','流年','liu21st@gmail.com','0000-00-00 00:00:00','0000-00-00 00:00:00','0','保密','0','0','0','','0','','','','45');

INSERT INTO `tao_member` VALUES('2','ertert','db0b04e4df30d7958af94ed81189400c','ewrw','32424@qq.com','0000-00-00 00:00:00','0000-00-00 00:00:00','1','保密','0','0','0','','0','','','','47');

INSERT INTO `tao_member` VALUES('3','','d41d8cd98f00b204e9800998ecf8427e','','','0000-00-00 00:00:00','0000-00-00 00:00:00','0','保密','0','0','0','','0','','','','48');

INSERT INTO `tao_member` VALUES('4','rthfghjgfh','21232f297a57a5a743894a0e4a801fc3','fdsf','dsfds@gf','0000-00-00 00:00:00','0000-00-00 00:00:00','1','保密','0','0','0','','0','','','','49');
...
DROP TABLE IF EXISTS `tao_menu`;

CREATE TABLE `tao_menu` (
...
INSERT INTO `tao_menu` VALUES('1','常用操作','','0','1');

INSERT INTO `tao_menu` VALUES('2','菜单管理','/taotao/admin.php/Menu/index','1','0');

INSERT INTO `tao_menu` VALUES('3','系统设置','','0','false');

INSERT INTO `tao_menu` VALUES('4','后台用户管理','/taotao/admin.php/User/index','3','0');

INSERT INTO `tao_menu` VALUES('5','用户组设定','/taotao/admin.php/Role/index','3','0');

INSERT INTO `tao_menu` VALUES('6','节点管理','/taotao/admin.php/Node/index','3','0');

INSERT INTO `tao_menu` VALUES('7','数据库备份/还原','/taotao/admin.php/DB/index','3','false');
...
INSERT INTO `tao_node` VALUES('49','read','查看','1','','','30','3','0','0');

INSERT INTO `tao_node` VALUES('40','Index','默认模块','1','','1','1','2','0','0');

INSERT INTO `tao_node` VALUES('39','index','列表','1','','','30','3','0','0');

INSERT INTO `tao_node` VALUES('34','update','更新','1','','','30','3','0','0');

INSERT INTO `tao_node` VALUES('33','edit','编辑','1','','','30','3','0','0');

INSERT INTO `tao_node` VALUES('32','insert','写入','1','','','30','3','0','0');

INSERT INTO `tao_node` VALUES('31','add','新增','1','','','30','3','0','0');

INSERT INTO `tao_node` VALUES('30','Public','公共模块','1','','2','1','2','0','0');

INSERT INTO `tao_node` VALUES('7','User','后台用户','1','','4','1','2','0','2');

INSERT INTO `tao_node` VALUES('6','Role','角色管理','1','','3','1','2','0','2');

INSERT INTO `tao_node` VALUES('2','Node','节点管理','1','','2','1','2','0','2');

INSERT INTO `tao_node` VALUES('1','Admin','后台管理','1','','1','0','2','0','0');
...
INSERT INTO `tao_notes` VALUES('1','51','362','blue','1','null');
...
INSERT INTO `tao_session` VALUES('maspo9frqp0t1klhiujjd4s761','1374412731','verify|s:32:\"c87579e7369697e409f6d7767838ced5\";authId|s:1:\"1\";email|s:17:\"liu21st@gmail.com\";loginUserName|s:9:\"ç®¡ç†å‘˜\";lastLoginTime|s:10:\"1374404126\";login_count|s:3:\"975\";admin|b:1;');
...
INSERT INTO `tao_user` VALUES('1','admin','管理员','21232f297a57a5a743894a0e4a801fc3','','1374406057','127.0.0.1','976','8888','liu21st@gmail.com','备注信息','1222907803','1239977420','1','0','');

INSERT INTO `tao_user` VALUES('2','demo','演示','fe01ce2a7fbac8fafaed7c982a04e229','','1373978880','127.0.0.1','95','8888','','','1239783735','1254325770','1','0','');
